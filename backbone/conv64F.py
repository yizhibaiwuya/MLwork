...
This file contains Conv64F(ReLU/LeakyReLU).
"""
...
class Conv64F(nn.Module):
    """
    Four convolutional blocks network, each of which consists of a Convolutional layer,
    ...
    def __init__(
        ...
        negative_slope=0.2,
        last_pool=True,
        maxpool_last2=True,  # False for spatial size = 11, True for spatial size = 5
    ):
